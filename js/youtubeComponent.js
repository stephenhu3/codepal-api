function mvc() {
    var model = {
        ...
        init: function () {
            ...
            if (!localStorage.selectedVideoNumber) localStorage.selectedVideoNumber =
                JSON.stringify({});
        },
        add: function (obj) {
            ...
            $('form#searchForm').on("submit", function (e) {
                ...
                request.execute(function (response) {
                    response.items.forEach(function (
                        video) {
                        var videoTitle = video.snippet
                            .title;
                        var videoImage = video.snippet
                            .thumbnails.default
                            .url;
                        var videoIdentity =
                            video.id.videoId;
                        var videoDesc = video.snippet
                            .description
                        controller.addVideo(
                            videoTitle,
                            videoImage,
